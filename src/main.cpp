...
unsigned int nTargetSpacing = 1 * 60; // 60 sec blocks
unsigned int nStakeMinAge = 8 * 60 * 60; // 8 hours
unsigned int nStakeMaxAge = 14 * 24 * 60 * 60; // 2 weeks
...
const string strMessageMagic = "OlympCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	{ 
		nSubsidy = 3000000 * COIN; return nSubsidy; 
	}
    else if(pindexBest->nHeight < 1575360)
	{
        nSubsidy = 31 * COIN;
    }
	else if(pindexBest->nHeight > 1575360)
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "OlympCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Genesis of OlympCoin. 8/10/2016";
        CTransaction txNew;
        txNew.nTime = 1470831818;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		uint256 nhashMerkleRoot = uint256("e695a780300aec90b88ba77a0dea1a507be80dcedfb6656d8c80da14185badc8");
...
unsigned char pchMessageStart[4] = { 0xb2, 0xc4, 0xd1, 0xa3 };
